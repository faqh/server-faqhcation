...
module.exports = {
    landingPage: async (req, res) =>{
        try {
            ...
            const treveller = await Traveller.find()
            ...
            const testimonial = {
                ...
                name: "Happy Customer",
                rate: 4.55,
                content: "What a great trip with my family and I should try again next time... ",
                familyName: "Steve",
    ...
    bookingPage: async (req, res) => {
        try {
            ...
            if (
                ...
                return res.status(404).json({message: 'Please fill this field'})
