...
module.exports = {
    ...
    showImageItem : async (req, res) => {
        try {
            ...
            const alert = { message: alertMessage, status: alertStatus};
            res.render('admin/item/viewItem', {
                title : "faqhcation | Show Image Item",
                alert,
                item,
                action: 'show image',
                user: req.session.user
    ...
    viewDetailItem : async (req, res) => {
        ...
        try {
            ...
            res.render('admin/item/detail-item/viewDetailItem', {
                title : "faqhcation | Detail Item",
                alert,
                itemId,
                feature,
                activity,
        ...
        const { id } = req.params; 
         try {
            ...
            res.render('admin/booking/showDetailBooking', {
                title : "faqhcation | Detail Booking",
                user: req.session.user,
                booking,
                alert
            });    
